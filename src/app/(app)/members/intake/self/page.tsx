...
export default async function SelfIntakePage() {
  ...
  return (
    <>
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-gray-900">Individual Registration</h1>
        <p className="mt-0.5 text-sm text-gray-500">Add a single person to the church directory.</p>
      </div>
      <IntakeForm mode="self" orgId={profile.org_id} />
      <ScriptureFooter />
    </>
  );
}

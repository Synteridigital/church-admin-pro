...
export default async function HouseholdIntakePage() {
  ...
  return (
    <>
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-gray-900">Household Registration</h1>
        <p className="mt-0.5 text-sm text-gray-500">Add yourself, your spouse, and children together.</p>
      </div>
      <IntakeForm mode="household" orgId={profile.org_id} />
      <ScriptureFooter />
    </>
  );
}

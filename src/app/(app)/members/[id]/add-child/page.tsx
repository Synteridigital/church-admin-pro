...
export default async function AddChildPage({
  ...
  return (
    <>
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-gray-900">Add child</h1>
        <p className="mt-0.5 text-sm text-gray-500">
          Create a new member record and link them as {member.full_name}&rsquo;s child.
        </p>
      </div>
      <AddPersonForm memberId={id} role="child" />
    </>
  );
}
